...
In each case \modified{the noise is heteroskedastic, and} there are $N=8$ epochs.
...
\modified{We tested a version of standard practice by removing bad pixels prior to interpolation, and concluded that our more conservative approach did not introduce any additional large variance.}
